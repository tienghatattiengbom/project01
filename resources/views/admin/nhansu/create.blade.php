    ...
    <div class="col-md-12">
      <div class="box box-primary" style="padding-bottom: 10px">
        ...
        <div class="form-group row" style="margin-top: 20px">
          ...
          <div class="col-md-8">
            <?= Form::text('name',null,['class' => 'form-control input-form','required'=>'required']) ?>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?= Form::text('addrees',null,['class' => 'form-control input-form','required'=>'required']) ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?php if ($errors->has("phone")): ?>
              <?= Form::text('phone',old('phone'),['class' => 'form-control input-form has-error','required'=>'required',]); ?>
              <span class="text-danger">{{ $errors->first('phone') }}</span>
            <?php else: ?>
              <?= Form::text('phone',old('phone'),['class' => 'form-control input-form','required'=>'required',]); ?>
            <?php endif ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?php if ($errors->has("email")): ?>
              <?= Form::email('email',null,['class' => 'form-control input-form has-error','required'=>'required']) ?>
              <span class="text-danger">{{ $errors->first('email') }}</span>
            <?php else: ?>
              <?= Form::email('email',null,['class' => 'form-control input-form','required'=>'required']) ?>
            <?php endif ?>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?= Form::text('birthday',null,['class' => 'form-control input-form ','data-inputmask'=>"'alias': 'dd-mm-yyyy'", 'data-mask'=>'']) ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?= Form::select('sex', ['M' => 'Nam', 'F' => 'Nữ'],null,['class' => 'form-control input-form'])?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8">
            <?= Form::text('salary_basic' ,null,['class' => 'form-control input-form','onkeyup' => 'FormatNumber(this)'])?>
          </div>
        </div>
