...
<section class="content row">
	<div class="col-md-12" style="padding: 0px">
		<div class="box box-primary" style="padding-bottom: 10px">
			{!! Form::open(['method' => 'POST', 'url' => '/admin/hopdong/update/'.$hopdong->id]) !!}
				<div class="form-group row" style="margin-top: 20px">
					<div class="col-md-3 label-form">
						<?= Form::label('nhansu_id', 'Nhân viên') ?>
					</div>
					<div class="col-md-8">
						<?= Form::select('nhansu_id', $nhanvien,$hopdong->nhansu_id,['class' => 'form-control input-form'])?>
					</div>
				</div>
				...
				<div class="form-group row" style="margin-top: 20px">
					...
					<div class="col-md-8">
						<?= Form::text('ma_hd',$hopdong->ma_hd,['class' => 'form-control input-form','required'=>'required']) ?>
					</div>
				</div>
				...
				<div class="form-group row" style="margin-top: 20px">
					...
					<div class="col-md-8">
						<?= Form::text('ten_hd',$hopdong->ten_hd,['class' => 'form-control input-form','required'=>'required']) ?>
					</div>
				</div>
				...
				<div class="form-group row" style="margin-top: 20px">
					...
					<div class="col-md-8">
						<?= Form::text('ngay_ki',$hopdong->ngay_ki,['class' => 'form-control input-form','required'=>'required','id'=>'datemask']) ?>
					</div>
				</div>
				...
				<div class="form-group row" style="margin-top: 20px">
					...
					<div class="col-md-8">
						<?= Form::text('ngay_het_han',$hopdong->ngay_het_han,['class' => 'form-control input-form','required'=>'required','id'=>'datemask1']) ?>
					</div>
				</div>
				...
				<div class="form-group row" style="margin-top: 20px">
					...
					<div class="col-md-8">
						<?= Form::select('status', [0=>'Không kích hoạt',1=>'Kích hoạt'],$hopdong->status,['class' => 'form-control input-form'])?>
					</div>
				</div>
