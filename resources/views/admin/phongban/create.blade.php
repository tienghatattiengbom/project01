...
<section class="content row">
	<div class="col-md-12" style="padding: 0px">
		<div class="box box-primary" style="padding-bottom: 10px">
			{!! Form::open(['method' => 'POST', 'url' => '/admin/phongban/create']) !!}
				<div class="form-group row" style="margin-top: 20px">
					<div class="col-md-3 label-form">
						<?= Form::label('ten_phongban', 'Tên Phòng Ban') ?>
					</div>
					<div class="col-md-8">
						<?= Form::text('ten_phongban',null,['class' => 'form-control input-form','required'=>'required']) ?>
					</div>
				</div>
				...
				<div class="form-group row" style="margin-top: 20px">
					...
					<div class="col-md-8">
						<?= Form::text('ma_phongban',null,['class' => 'form-control input-form','required'=>'required']) ?>
					</div>
				</div>
